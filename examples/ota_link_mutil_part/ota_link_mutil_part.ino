...
/*  Note
 *  Ví dụ mẫu về việc chia nhỏ file .bin thành nhiều phần nếu file .bin có size lớn hơn cache của module SIM. Sử dụng chat GPT và ra lệnh cắt file .bin của bạn thành 2 phần (hoặc nhiều hơn)
 *  1.Trong hàm setup gọi SIM7600_on_lte_ready_callback để đăng kí sự kiện LTE sẵn sàng
 *  2.Dùng ota_start để download file ota thông qua giao thức http
